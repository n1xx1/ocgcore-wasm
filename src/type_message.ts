...
export const effectClientModeStrings = makeMap([
  [OcgEffectClientMode.NORMAL, "normal"],
  [OcgEffectClientMode.RESOLVE, "resolve"],
  [OcgEffectClientMode.RESET, "reset"],
]);

export const messageCardHintTypeStrings = makeMap([
  [OcgMessageCardHintType.TURN, "turn"],
  [OcgMessageCardHintType.CARD, "card"],
  [OcgMessageCardHintType.RACE, "race"],
  [OcgMessageCardHintType.ATTRIBUTE, "attribute"],
  [OcgMessageCardHintType.NUMBER, "number"],
  [OcgMessageCardHintType.DESC_ADD, "desc_add"],
  [OcgMessageCardHintType.DESC_REMOVE, "desc_remove"],
]);

export const messageTypeStrings = makeMap([
